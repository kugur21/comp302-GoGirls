...
public class Constants {
    ...
    public static final int BUILD_AIR_X = (int) (BUILD_GRID_OFFSET_X + (WINDOW_WIDTH * 0.39));
    public static final int BUILD_AIR_Y = BUILD_GRID_OFFSET_Y;
    public static final int BUILD_WATER_X = BUILD_GRID_OFFSET_X;
    public static final int BUILD_WATER_Y = (int) (BUILD_GRID_OFFSET_Y + (WINDOW_HEIGHT * 0.50));
    public static final int BUILD_FIRE_X = (int) (BUILD_GRID_OFFSET_X + (WINDOW_WIDTH * 0.39));
    public static final int BUILD_FIRE_Y = (int) (BUILD_GRID_OFFSET_Y + (WINDOW_HEIGHT * 0.50));

    // Inventory settings
    public static final int BUILD_INVENTORY_X = (int) (WINDOW_WIDTH * 0.77);
    public static final int BUILD_INVENTORY_Y = (int) (WINDOW_HEIGHT * 0.28);
